...
const WORDS = ["Computer Science Graduate", "Tech Enthusiast"];
const TECH_STACK = ["Next JS", "React JS", "Laravel", "Tailwind CSS"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/masabqurban" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/masab-qurban/" },
  { icon: Instagram, link: "https://www.instagram.com/masabqurban/" }
];
...
const Home = () => {
  ...
  return (
    <div className="px-5 min-h-screen bg-[#030014] overflow-hidden" id="Home">
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 md:mt-36 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Building Modern, Responsive, and User-Centric Websites with Cutting-Edge Technologies.
                </p>
